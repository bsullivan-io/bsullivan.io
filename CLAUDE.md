...
Personal portfolio and resume website for Brian Sullivan, a full-stack web engineer with 15+ years of experience. Hosted at **bsullivan.io** via GitHub Pages. The home page is an interactive **Mac OS 8 "Platinum" desktop** (draggable, collapsible windows), while the resume page keeps a dark terminal/hacker aesthetic, with a separate print-optimized layout.
...
### `home.html` — Mac OS 8 Desktop Home Page
- Interactive "Platinum" desktop: a teal background with multiple draggable windows (beveled chrome, pinstriped title bars, close/collapse/zoom boxes)
...
|-------|---------|-------------|
| Mac OS 8 Platinum | `home.html` | Teal desktop, beveled gray windows, pinstriped title bars, draggable/collapsible (interactive) |
