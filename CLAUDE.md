...
- Interactive desktop: a warm clay background with multiple draggable windows (cream beveled chrome, **colored + textured title bars** — brick-red on the focused window, tan on the rest — and close/collapse/zoom boxes); red/tan accent scheme throughout (red name, filled-red default button, red selection highlights)
...
|-------|---------|-------------|
| Retro-inspired desktop | `home.html` | Warm clay desktop, cream beveled windows, colored textured title bars (red active / tan inactive), red/tan accents, draggable/collapsible (interactive) |
